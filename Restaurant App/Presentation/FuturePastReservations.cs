    ...
    static class FuturePastResrvations
    {
        ...
        private static void ViewAdmin(UserModel acc)
        {
            ...
            while (true)
            {
                ...
                string selectedReservation = SelectionPresent.Show(reservationOptions, banner: "RESERVATION MENU").ElementAt(0).text; // displaying the info as opions to choose

                if (selectedReservation == null ||selectedReservation == "Back")
                {
                    return;
                }
        ...
        private static void ViewUser(UserModel acc)
        {
            ...
            while (true)
            {
                ...
                if (selectedReservations == null || selectedReservations == "Back")
                {
                    return;
                }
