public static class ReservationDetails
{
    public static void ShowDetails(ReservationModel reservation)
    {
        ...
        var account = AccountsAccess.GetById((int)reservation.UserID);
        ...
        Console.WriteLine();
        Console.WriteLine($"Reservation Date: {FormatDate(reservation.Date)}");
        Console.WriteLine($"Assigned Table number: {reservation.TableID}");
